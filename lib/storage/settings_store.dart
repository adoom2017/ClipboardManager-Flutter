...
class SettingsStore extends ChangeNotifier {
  ...
  String get syncPairedPeers => _syncPairedPeers;
  ...
  Future<void> init() async {
    ...
    _syncPairedPeers = _prefs.getString('syncPairedPeers') ?? '[]';
  }
  ...
  Future<void> setAutoSync(bool v) async {
    _autoSync = v;
    await _prefs.setBool('autoSync', v);
    notifyListeners();
  }
  ...
  Future<void> setSyncPairedPeers(String v) async {
    _syncPairedPeers = v;
    await _prefs.setString('syncPairedPeers', v);
    notifyListeners();
  }
